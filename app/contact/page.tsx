  ...
  return (
    <section className="text-gray-600 body-font relative">
      <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
        ...
        <div className="lg:w-1/3 md:w-1/2 rounded flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0 prose dark:prose-invert">
          <h2 className="mb-2 font-medium title-font">Get In Touch</h2>
